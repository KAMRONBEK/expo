...
import { AdbProcessWaitError, runAdbHostQueryAsync } from '../adbProcess';
...
function fixtureServer(name: string): ADBServer {
  return {
    runHostQueryAsync(args: string[], operation: string, signal?: AbortSignal) {
